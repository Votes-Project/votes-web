...
module Types = {
  ...
  type rec fragment_voteTransfers_edges_node = {
    @live id: string,
    tokenId: string,
    fragmentRefs: RescriptRelay.fragmentRefs<[ | #AuctionList_AuctionItem_voteTransfers]>,
  }
...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #AuctionListDisplay_voteTransfers]> => fragmentRef = "%identity"

@live
@inline
let connectionKey = "AuctionListDisplay_voteTransfers_voteTransfers"

%%private(
  @live @module("relay-runtime") @scope("ConnectionHandler")
  external internal_makeConnectionId: (RescriptRelay.dataId, @as("AuctionListDisplay_voteTransfers_voteTransfers") _, 'arguments) => RescriptRelay.dataId = "getConnectionID"
)
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__AuctionListDisplay_voteTransfers_voteTransfers_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
